...
public class POMPAGE {
	public static void main(String[] args) throws Throwable { 
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		 ...
		 Scenario2.Firstname(driver).sendKeys("Divya");
		 ...
		 Scenario2.username1(driver).sendKeys("divya@1997");
		 Scenario2.password1(driver).sendKeys("Divya@1997");
		 Scenario2.confirmpw(driver).sendKeys("Divya@1997");
		 ...
		 Scenario3.Work(driver).sendKeys("Divi@gmail.com");
		 Scenario3.workemail(driver).sendKeys("Divi@gmail.com");
		 Scenario3.otheremail(driver).sendKeys("Divyasri@gmail.com");
		 ...
		 Scenario6.name(driver).sendKeys("Divya");
